...
CODIGO_INSTRUCAO_MOVIMENTO_400 = [
    ('01', u'01 - Remessa'),
    ('02', u'02 - Pedido de baixa'),
    ('03', u'03 - Pedido de Protesto Falimentar'),
    ('04', u'04 - Concessão de abatimento'),
    ('05', u'05 - Cancelamento de abatimento concedido'),
    ('06', u'06 - Alteração de vencimento'),
    ('07', u'07 - Alteração do controle do participante'),
    ('08', u'08 - Alteração de seu número'),
    ('09', u'09 - Pedido de protesto'),
    ('18', u'18 - Sustar protesto e baixar Título'),
    ('19', u'19 - Sustar protesto e manter em carteira'),
    ('20', u'20 - Alteração de valor*'),
    ('21', u'21 - Alteração de valor com emissão de Boleto (quando a emissão é pelo Banco)*'),
    ('22', u'22 - Transferência Cessão crédito ID. Prod.10'),
    ('23', u'23 - Transferência entre Carteiras'),
    ('24', u'24 - Dev. Transferência entre Carteiras'),
    ('31', u'31 - Alteração de outros dados'),
    ('045', u'045 - Pedido de Negativação'),
    ('046', u'046 - Excluir Negativação com baixa'),
    ('047', u'047 - Excluir negativação e manter pendente'),
    ('68', u'68 - Acerto nos dados do rateio de Crédito'),
    ('69', u'69 - Cancelamento do rateio de crédito (uso futuro).')
]
